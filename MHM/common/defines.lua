...
country = {
	...
	BASE_GREATPOWER_DAILY_INFLUENCE = 0.20, -- Influence value which is distributed each day
...
military = {
    ...
    SIEGE_BRIGADES_MAX = 30, -- the number of brigades above which you get no addition benefit in sieges
    SIEGE_BRIGADES_BONUS = 0.5, -- the bonus to siege speed from each brigade
    RECON_SIEGE_EFFECT = 0.35, -- multiplier to effect of recon on speeding up sieges
...
diplomacy = {
	...
	ASKMILACCESS_RELATION_ON_ACCEPT = 50,
	ASKMILACCESS_RELATION_ON_DECLINE = -25,
	...
	CANCELGIVEMILACCESS_RELATION_ON_ACCEPT = -25,
